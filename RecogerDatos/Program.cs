...
class Program
{
    ...
    static async Task TareaAsincrona()
    {
        ...
        var key = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJtZXQwMS5hcGlrZXkiLCJpc3MiOiJJRVMgUExBSUFVTkRJIEJISSBJUlVOIiwiZXhwIjoyMjM4MTMxMDAyLCJ2ZXJzaW9uIjoiMS4wLjAiLCJpYXQiOjE2NDMzNjE4MTAsImVtYWlsIjoiaWthY3pAcGxhaWF1bmRpLm5ldCJ9.nu0Zy6quNNWlLrHZTuiaHKlC9o1ak30FfB564Uw8UiLJ9hFuNrYYGKqlljzgCstTRpYGRT0ZbRWfDNpm64x5MRap1xB-QpPMHTosdriUM4yiASWoKsZlYWmGXt1u8hq-twQXE5Wo2yi4FzEYWpOWeZjBF4pmdxalUTXV0phVQQBrQ1G7zj4bBINpNNu6l9K7k2-oScfXIZNr80zhuaM_Ni26NGj3kRryR-GvSvRZJ5_UYYoh24ydtoNdLEDiurZ_qlS1suIqD-m5s__nPUuieCNM_OnJibDXOiDIU84vStyeyKXHpGxju3qt-cvIpF_4NMn-syAfL_ZBiCetaWSpsA";
                ...
                using (var db = new WebApiTiempoContext())
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            // db.Tiempo.Add(itemNuevo);
                            // db.SaveChanges();



                            string localizacion = itemNuevo.Municipio;
                            var row = db.Tiempo.Where(a => a.Municipio == localizacion).Single();
